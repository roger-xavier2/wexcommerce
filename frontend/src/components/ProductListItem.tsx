...
import { getProductPath, isValidProductUrl } from '@/utils/productUrl'
...
const ProductListItem: React.FC<ProductListItemProps> = (
  ...
  return (
    <article key={product._id} className={styles.product} style={style}>
      <Link
        href={(isValidProductUrl(product.url, product._id) && product.url) || getProductPath(product._id, product.name)}
        title={product.name}
